    ...
    if (edit && editPost) {
        ...
        if (typeof window.orientation !== "undefined" || navigator.userAgent.indexOf('IEMobile') !== -1) {
            ...
            window.tinymce.init({
                ...
                toolbar1: 'formatselect | bold italic blockquote forecolor backcolor | imageupload link | alignleft aligncenter alignright  | numlist bullist outdent indent |  codesample  | fullscreen',
